...
salary_slider = gr.components.Slider(minimum=80e3, maximum=200e3, label="Gross salary")
...
**Some minor and complex tax deductions were not taken into account. Based on the estimations above and my desire to earn 
at around 4000 Euro a month, the projected self-employed salary would be around 160K Euro a year.**
...
net_salary = gr.components.Textbox(label="Estimated net salary")
